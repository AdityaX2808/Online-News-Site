        ...
        <div class="header-top" style="padding-bottom:30px;">
            <div class="container">
                ...
                <div class="header-top-left no-padding ">
                        <ul>
                            <li><a href="<?= url('login') ?>"><span class="lnr lnr-enter-down"></span><span style="font-size:15px;"> </span></a></li>
                            <li><a href="<?= url('register') ?>"><span class="lnr lnr-user"></span><span style="font-size:15px;"> </span></a></li>
